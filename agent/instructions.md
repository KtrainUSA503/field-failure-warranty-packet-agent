...
- sourcesSummary: a "·"-separated list of source names + dates only, no descriptions. E.g., "Unit Registry (03-unit-registry.csv) · Reyes/Okafor Teams chat (Jun 1) · Reyes/Nair thread (Jun 2) · Meeting with Contoso Company chat (Jun 1) · Policy WAR-POL-GF-200 §1–§3 · Manual §3.2".
