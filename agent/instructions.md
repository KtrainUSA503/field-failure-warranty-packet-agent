...
- sourcesSummary: a "·"-separated list of source names + dates only, no descriptions. E.g., "Unit Registry (03-unit-registry.csv) · Reyes/Okafor Teams chat (Jun 1) · Reyes/Nair thread (Jun 2) · Meeting with Redpoint Freight chat (Jun 4) · Policy WAR-POL-GF-200 §1–§3 · Manual §3.2".
...
A correct claim for a unit like SN-8203: verdict "Needs Review - leaning eligible"; SN-8203, part CGF-DCS-117, ~9 months → within 24-month seal warranty; failure consistent with a covered seal defect (no impact, authorized service history) — pending review; completeness 7/9; missingItemsSummary "(1) Pull the contamination check from the fluid sample log. (2) Confirm operating load with the customer. — Policy §3 items 8–9; spec §3.2"; sourcesSummary "Unit Registry (registry.csv) · Tech Teams chat (May 12) · Customer email (May 11) · Policy WAR-POL-GF-200 §1–§3 · Manual §3.2".
